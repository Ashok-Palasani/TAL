    ...
    public class UserController : Controller
    {
        ...
        public string GetUserMenus()
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("GetUserMenus", mc.sqlConnection))
                    {
        ...
        public string GetCheckboxesForUser(int roleId)
        {
            ...
            try
            {
                using (MsqlConnection mc = new MsqlConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("GetCheckboxesForUser", mc.sqlConnection))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
                            mc.open();
        ...
        public string GetSideMenubar()
        {
            ...
            try
            {
                using (MsqlConnection mc = new MsqlConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("GetSideMenubar", mc.sqlConnection))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
                            mc.open();
        ...
        public string GetDashboardMenus()
        {
            ...
            try
            {
                using (MsqlConnection mc = new MsqlConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("GetDashboardMenus", mc.sqlConnection))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
                            mc.open();
