...
namespace UnitWorksCCS
{
    public class ProgramTransfer
    {
        ...
        internal string GetVersionListPCProgram(String MacInv, String ProgNo, out List<ProgramVersionListDet> PrgVerList)
        {
            ...
            int macId = db.tblmachinedetails.Where(m => m.MachineInvNo == MacInv).Select(m => m.MachineID).FirstOrDefault();//Convert.ToInt32(MacInv);
        ...
        // Commented by Monika Because we r not using 
